...
{
	public class DetailPage09Val
	{
		public static bool signed;
		public static bool fav;
	}
	public class detailpage09Model : PageModel
    {
		public string _pagename = "王海旭：忠诚拼搏 锻造过硬实力";
		public string _pagelink = "/PageDetail/detailpage09";

		private string connectionString = "Server=localhost;User ID=root;Password=Root12345@;Database=user_info";
		public void OnGet()
		{
			DetailPage09Val.signed = User.Identity.IsAuthenticated;
			if (DetailPage09Val.signed)
			{
				try
				{
