...
{
	//
	public class CappuccinoVal
	{
		public static bool signed;
		public static bool fav;
	}

	public class CappuccinoModel : PageModel
    {
		//
		public string _pagename = "Cappuccino";
		public string _pagelink = "/PageDetail/cappuccino";

		private string connectionString = "Server=localhost;User ID=root;Password=Root12345@;Database=user_info";
		public void OnGet()
        {
			CappuccinoVal.signed = User.Identity.IsAuthenticated;
			if (CappuccinoVal.signed)
            {
                try
                {
