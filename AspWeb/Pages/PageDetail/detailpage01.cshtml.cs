...
{
	public class DetailPage01Val
	{
		public static bool signed;
		public static bool fav;
	}
	public class detailpage01Model : PageModel
    {
		public string _pagename = "弘扬爱国文化 致敬红色经典";
		public string _pagelink = "/PageDetail/detailpage01";

		private string connectionString = "Server=localhost;User ID=root;Password=Root12345@;Database=user_info";
		public void OnGet()
		{
			DetailPage01Val.signed = User.Identity.IsAuthenticated;
			if (DetailPage01Val.signed)
			{
				try
				{
