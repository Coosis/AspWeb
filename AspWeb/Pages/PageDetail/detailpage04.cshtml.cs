...
{
	public class DetailPage04Val
	{
		public static bool signed;
		public static bool fav;
	}
	public class detailpage04Model : PageModel
    {
		public string _pagename = "一起行走，看乡土新风";
		public string _pagelink = "/PageDetail/detailpage04";
		private string connectionString = "Server=localhost;User ID=root;Password=Root12345@;Database=user_info";
		public void OnGet()
        {
			DetailPage04Val.signed = User.Identity.IsAuthenticated;
			if (DetailPage04Val.signed)
			{
				try
				{
