...
{
	public class DetailPage06Val
	{
		public static bool signed;
		public static bool fav;
	}
	public class detailpage06Model : PageModel
    {
		public string _pagename = "传承红色基因 赓续红色血脉";
		public string _pagelink = "/PageDetail/detailpage06";

		private string connectionString = "Server=localhost;User ID=root;Password=Root12345@;Database=user_info";
		public void OnGet()
		{
			DetailPage06Val.signed = User.Identity.IsAuthenticated;
			if (DetailPage06Val.signed)
			{
				try
				{
